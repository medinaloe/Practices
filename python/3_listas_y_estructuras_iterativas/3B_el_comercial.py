...
total_ventas =sum (cantidad_productos)
factutacion_por_producto = []
factutacion_por_producto = []

dinero_total= 0

for i in range(0,len(precio_productos)):
 dinero_por_producto = precio_productos[i] * cantidad_productos[i]
 factutacion_por_producto.append(dinero_por_producto)
 dinero_total= dinero_total + dinero_por_producto

print("La cantidad total de ventas es de ", total_ventas)
print("El dindero facturado por producto es de ", factutacion_por_producto)
print("El dinero total ganado es de ", dinero_total, "EU.")
